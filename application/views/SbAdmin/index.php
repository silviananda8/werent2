  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('welcome/index')?>">
        ...
        <div class="sidebar-brand-text text-gray-100 mx-3">WeRent<sup>Admin</sup></div>
      </a>
      ...
      <!-- Nav Item - grocery -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('welcome/tabel')?>">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    <div class="small text-gray-100">December 12, 2019</div>
      ...
      tooltips: {
        ...
        callbacks: {
          label: function(tooltipItem, chart) {
            ...
            return "Total Pendapatan Bulan ini adalah" + ' Rp.' + number_format(tooltipItem.yLabel);
          }
        }
      }
    }
