...
<head>
  ...
  <title>WeRent Admin konten</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('auth/home_admin')?>">
        ...
        <div class="sidebar-brand-text mx-3">WeRent<sup>Admin</sup></div>
      </a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="embed-responsive embed-responsive-21by9">
              <iframe class="embed-responsive-item" src="<?php echo site_url('c_artikel/data_keuangan')?>"></iframe>
          </div>
