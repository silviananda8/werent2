...
class grafik_m  extends CI_Model  {
    ...
    function pesan($ID_USER,$ID_MOBIL,$KODE_PEMESANAN,$LOKASI_PENGANTARAN,$LOKASI_PENJEMPUTAN,$TANGGAL_PENGAMBILAN,$TANGGAL_PENGEMBALIAN,$TOTAL){
       $sql=$this->db->query("INSERT INTO pesanan (ID_USER,ID_MOBIL,KODE_PEMESANAN,LOKASI_PENGANTARAN,LOKASI_PENJEMPUTAN,TANGGAL_PENGAMBILAN,TANGGAL_PENGEMBALIAN,TOTAL)VALUES ('$ID_USER','$ID_MOBIL','$KODE_PEMESANAN','$LOKASI_PENGANTARAN','$LOKASI_PENJEMPUTAN','$TANGGAL_PENGAMBILAN','$TANGGAL_PENGEMBALIAN','$TOTAL')");
        return $sql;
    }
    function pesan2($ID_USER,$ID_MOTOR,$KODE_PEMESANAN,$LOKASI_PENGANTARAN,$LOKASI_PENJEMPUTAN,$TANGGAL_PENGAMBILAN,$TANGGAL_PENGEMBALIAN,$TOTAL){
       $sql=$this->db->query("INSERT INTO pesanan (ID_USER,ID_MOTOR,KODE_PEMESANAN,LOKASI_PENGANTARAN,LOKASI_PENJEMPUTAN,TANGGAL_PENGAMBILAN,TANGGAL_PENGEMBALIAN,TOTAL)VALUES ('$ID_USER','$ID_MOTOR','$KODE_PEMESANAN','$LOKASI_PENGANTARAN','$LOKASI_PENJEMPUTAN','$TANGGAL_PENGAMBILAN','$TANGGAL_PENGEMBALIAN','$TOTAL')");
        return $sql;
    }
    function pembayaran($KODE_PEMESANAN,$TANGGAL_PENGAMBILAN,$TANGGAL_PENGEMBALIAN){
       $sql=$this->db->query("SELECT * FROM pesanan WHERE KODE_PEMESANAN='$KODE_PEMESANAN'AND TANGGAL_PENGAMBILAN='$TANGGAL_PENGAMBILAN'AND TANGGAL_PENGEMBALIAN='$TANGGAL_PENGEMBALIAN'");
        return $sql;
    }
}
?>