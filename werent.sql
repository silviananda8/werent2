...
MySQL - 10.1.38-MariaDB : Database - werent
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`werent` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `artikel_pariwisata` (
  ...
  KEY `ID_ADMIN` (`ID_ADMIN`) USING BTREE,
  CONSTRAINT `artikel_pariwisata_ibfk_1` FOREIGN KEY (`ID_ADMIN`) REFERENCES `admin` (`ID_ADMIN`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;

/*Data for the table `artikel_pariwisata` */
...
CREATE TABLE `kab_kota` (
  ...
  KEY `id_prov` (`id_prov`) USING BTREE,
  CONSTRAINT `kab_kota_ibfk_1` FOREIGN KEY (`id_prov`) REFERENCES `prov` (`ID_PROV`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `mobil` (
  ...
  KEY `ID_RENTAL` (`ID_RENTAL`) USING BTREE,
  CONSTRAINT `mobil_ibfk_1` FOREIGN KEY (`ID_RENTAL`) REFERENCES `rental` (`ID_RENTAL`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `motor` (
  ...
  KEY `ID_RENTAL` (`ID_RENTAL`) USING BTREE,
  CONSTRAINT `motor_ibfk_1` FOREIGN KEY (`ID_RENTAL`) REFERENCES `rental` (`ID_RENTAL`) ON DELETE CASCADE ON UPDATE CASCADE
...
(1,2,'2000000005.jpg','DUCATI','Panigale V4',NULL,'motor','Manual',1300000,1,0,'Tidak'),
(4,1,'ninja.jpg','Kaw','Nin','motor woww',NULL,NULL,600000,1,NULL,NULL),
(7,1,'ninja2.jpg','m','n','d',NULL,NULL,900000,1,NULL,NULL);
...
CREATE TABLE `pemilik` (
  ...
  KEY `ID_USER` (`ID_USER`) USING BTREE,
  CONSTRAINT `pemilik_ibfk_1` FOREIGN KEY (`ID_USER`) REFERENCES `user` (`ID_USER`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `pesanan` (
  ...
  UNIQUE KEY `KODE_PEMESANAN` (`KODE_PEMESANAN`) USING BTREE,
  KEY `ID_PENYEWA` (`ID_USER`) USING BTREE,
  KEY `ID_Mobil` (`ID_Mobil`) USING BTREE,
  ...
  CONSTRAINT `pesanan_ibfk_2` FOREIGN KEY (`ID_MOTOR`) REFERENCES `motor` (`ID_MOTOR`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `pesanan_ibfk_3` FOREIGN KEY (`ID_Mobil`) REFERENCES `mobil` (`ID_MOBIL`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;

/*Data for the table `pesanan` */

insert  into `pesanan`(`ID_PESAN`,`ID_USER`,`ID_Mobil`,`ID_MOTOR`,`KODE_PEMESANAN`,`NAMA_PESAN`,`DETAIL`,`LOKASI_PENJEMPUTAN`,`LOKASI_PENGANTARAN`,`TANGGAL_PENGAMBILAN`,`TANGGAL_PENGEMBALIAN`,`TOTAL`) values 
(1,2,3,NULL,'GJGC8D','test',NULL,NULL,NULL,'2020-05-11 10:42:55','2020-05-12 10:43:06',2000000),
(2,2,2,NULL,'GJGC5D',NULL,NULL,NULL,NULL,'2020-05-13 11:09:47','2020-05-14 11:09:52',2500000),
(3,2,NULL,1,'YJT4N6',NULL,NULL,'Jl. Mawar','Jl. Mawar','2020-05-16 13:52:24','2020-05-19 13:52:27',1300000),
(4,2,2,NULL,'MB54TY',NULL,NULL,'Jl.Anggrek','Jl. Anggrek','2020-05-16 19:20:53','2020-05-23 19:20:57',2500000),
(5,5,2,NULL,'MJ8T6U',NULL,NULL,'Jl. Kencana','Jl. Kencana','2020-05-17 21:02:31','2020-05-18 21:02:34',2500000),
(6,2,2,NULL,'1K7CQ0',NULL,NULL,'Jl. Mawar','Jl. Mawar','2020-05-17 21:12:00','2020-05-31 21:12:00',4600000);
...
CREATE TABLE `rental` (
  ...
  `ALAMAT_RENTAL` varchar(200) DEFAULT NULL,
  ...
  KEY `ID_PEMILIK` (`ID_PEMILIK`) USING BTREE,
  KEY `ID_KOTA` (`ID_KOTA`) USING BTREE,
  CONSTRAINT `rental_ibfk_1` FOREIGN KEY (`ID_PEMILIK`) REFERENCES `pemilik` (`ID_PEMILIK`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `rental_ibfk_2` FOREIGN KEY (`ID_KOTA`) REFERENCES `kab_kota` (`id_kab`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;

/*Data for the table `rental` */

insert  into `rental`(`ID_RENTAL`,`ID_PEMILIK`,`ID_KOTA`,`NAMA_RENTAL`,`DESKRIPSI_RENTAL`,`ALAMAT_RENTAL`,`FOTO_RENTAL`,`LAMA_PEMESANAN_MINIMUM`,`JAM_BUKA`,`JAM_TUTUP`,`PERSYARATAN_JARAK_WAKTU_PEMESANAN`,`KEBIJAKAN_PEMBATALAN`,`HARI_1`,`HARI_2`,`PERSYARATAN_PENYEWA`,`PENGANTARAN`,`PENGEMBALIAN`,`MAP`) values 
...
(2,2,273,'Sumber Makmur','Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ac diam massa. Nunc eleifend, lorem at feugiat dapibus, lectus arcu cursus velit, vel viverra lectus odio pellentesque ipsum. Etiam ac magna ex. Integer justo dolor, pharetra fermentum consectetur eu, feugiat a sem. In varius erat quis neque tincidunt pretium. Sed cursus porta ipsum. Nulla euismod tristique justo, tempus iaculis magna dictum ut. Etiam non risus sit amet tellus blandit blandit. Donec quis sollicitudin odio, ac malesuada ante. Sed ornare tellus et lorem viverra, vitae congue magna auctor. Nam hendrerit lacus quis nisi dapibus, et condimentum metus facilisis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.','Jl. Jatinegara','Books_HD_8314929977-1024x682.jpg',5,'08:00:00','22:00:59',7,'','Senin','Minggu','','','','<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15830.334296910118!2d112.72642016792202!3d-7.288128631397597!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fb94c572e7eb%3A0xb06576d36acd5360!2sDarmo%2C%20Kec.%20Wonokromo%2C%20Kota%20SBY%2C%20Jawa%20Timur!5e0!3m2!1sid!2sid!4v1589290448091!5m2!1sid!2sid\" width=\"300\" height=\"200\" frameborder=\"0\" style=\"border:0;\" allowfullscreen=\"\" aria-hidden=\"false\" tabindex=\"0\"></iframe>'),
(4,5,247,'hmm showroom','kkkkkk','Jl. Cassablanca','flhtt4rrfb9412.jpg',1,'08:00:00','22:00:00',7,'nnnnnnnnn',NULL,NULL,'mmmmmm','ya','ya',NULL),
(5,7,249,'akbar showroom','iiiii','jl. kertas','avatar3.png',3,'07:00:00','10:00:00',10,'hhhhhhhhh',NULL,NULL,'gggggg','','',NULL);
...
CREATE TABLE `transaksi` (
  ...
  KEY `ID_PESAN` (`ID_PESAN`) USING BTREE,
  CONSTRAINT `transaksi_ibfk_1` FOREIGN KEY (`ID_PESAN`) REFERENCES `pesanan` (`ID_PESAN`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
